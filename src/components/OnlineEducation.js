...
export default function OnlineEducation() {
  return (
    <div className="lg:mx-[435px] flex justify-center mb-24">
      <div className="lg:h-[616px] w-[1050px] py-[160px]">
        <div className="hero">
          <div className="hero-content flex-col lg:flex-row space-x-20">
            <img
              ...
              className="lg:w-[300px] lg:h-[300px] min-w-sm"
            />
            <div className="">
              ...
              <p className="text-[14px] leading-5 w-[351px]">
