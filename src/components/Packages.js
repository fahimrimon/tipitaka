      ...
      <div className="lg:h-[616px] py-[160px]">
        <div className="lg:flex gap-[30px]">
          <div className="w-full">
            ...
            <h2 className="text-[40px] font-bold py-7 leading-10">
          ...
          <div className="w-full my-10">
            <div className="flex">
                ...
                <h1 className="text-[16px] font-bold leading-6 mt-3">Sales Planning</h1>
            <div className="w-12 h-0.5 bg-red-500 my-4"></div>
            <p className="w-[132px] text-[14px]">The gradual accumulation of information about</p>
                </div>
                ...
                <h1 className="text-[16px] font-bold leading-6 mt-3">Market Analysis</h1>
            <div className="w-12 h-0.5 bg-red-500 my-4"></div>
            <p className="w-[132px] text-[14px]">The gradual accumulation of information about</p>
                </div>
            </div>
